  ...
  return (
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-slate-600 rounded-xl group hover:bg-white hover:scale-[1.05] ease-in-out duration-500">
      ...
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        ...
        <Link to={projectUrl}>
          <p className="text-center py-3 rounded-lg bg-gradient-to-r from-purple-500 to-slate-500 text-navbar font-bold text-lg cursor-pointer hover:shadow-md hover:shadow-slate-500 ease-in duration-500">
            Go to Demo
          </p>
        </Link>
      </div>
