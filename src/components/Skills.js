...
import { TbBrandNextjs, TbExposurePlus1 } from "react-icons/tb";
	...
	return (
		<div id='skills'>
			...
			<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  p-4 min-[1300px]:grid-cols-4 gap-8'>
				<div className='p-6 shadow-xl rounded-xl hover:shadow-xl hover:shadow-[#993bf6] bg-slate-400 text-navbar hover:scale-[1.1] ease-in duration-300'>
