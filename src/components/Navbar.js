...
const Navbar = () => {
	...
	return (
		<div
			...
			<div className='font-poppins font-bold text-[24px]'>Muhammad Nur</div>
			<ul
				...
				<li className='bg-gradient-to-r from-purple-500 to-slate-500 hover:text-transparent bg-clip-text xl:hover:scale-110 cursor-pointer p-2'>
					<a href='/#home'>Home</a>
				</li>
				<li className='bg-gradient-to-r from-purple-500 to-slate-500 hover:text-transparent bg-clip-text xl:hover:scale-110 cursor-pointer p-2'>
